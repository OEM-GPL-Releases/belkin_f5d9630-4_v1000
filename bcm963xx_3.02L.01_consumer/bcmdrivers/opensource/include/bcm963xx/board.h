...
#define BLK128K                         (128*ONEK) // Joshua
#define FLASH45_BLKS_BOOT_ROM           1

#if 1 // Joshua - Intel flash J3C has the same size (128k) for each sector
#define FLASH45_LENGTH_BOOT_ROM         (FLASH45_BLKS_BOOT_ROM * BLK128K)
#define FLASH_RESERVED_AT_END           (128*ONEK) /*reserved for PSI, scratch pad*/
#else
